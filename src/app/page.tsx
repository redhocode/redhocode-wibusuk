...
export default function Home() {
  ...
  return (
    <>
      <div className="bg-gradient-to-r from-sky-400 to-green-300 min-h-screen flex justify-center items-center">
        <Card className="w-96 h-auto">
          <CardHeader>
            <CardTitle>
              ...
              <span className="text-3xl font-bold">
                Aplikasi Informasi manga dan Anime
              </span>
              <span>Project Portfolio by Redho Arifin</span>
              </div>
              <div className="flex flex-warp mt-4 gap-4">
                <div>
                  <Link href="https://github.com/redhocode">
                    <svg
                      role="img"
                      viewBox="0 0 24 24"
                ...
                <div>
                  <Link href="https://www.linkedin.com/in/redhocode/">
                    <svg
                      role="img"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <CardFooter>
            <div className="flex justify-between gap w-full">
              <Link href={"manga/popular"}>
              
            <Button variant="outline" className="bg-sky-400">Manga</Button>
              </Link>
            <Link href={"anime"}>

            <Button variant="outline"className="bg-green-400">Anime</Button>
            </Link>
            </div>
          </CardFooter>
        </Card>
